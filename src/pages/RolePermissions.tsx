...
const modules: { key: string; label: string }[] = [
  ...
  { key: 'samples.locations', label: '样品库位维护' },
  { key: 'samples.inbound', label: '样品入库' },
  { key: 'samples.outbound', label: '样品出库' },
  { key: 'samples.stock', label: '样品库存查询' },
  { key: 'samples.transactions', label: '库存流水' },
